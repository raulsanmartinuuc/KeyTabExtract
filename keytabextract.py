...
# Take argument 1 as keytab file
ktfile = sys.argv[1]
...
def ktextract():
    if '00170010' in hex_encoded:
        print("[*] It appears as though RC4-HMAC encryption has been used. Attempting Extraction...")
    else:
        print("[!] No NTLM Hash was discovered. This is usually because there is no rc4-hmac encryption type in the keytab file.\n[!] Exiting...")
        sys.exit()
    ...
    if keytype_dec == '23':
        ...
        encType = 'Unknown'
    print("\tENCRYPTION TYPE: 0017 (rc4-hmac)")
